...
int main()
{
	...
	for (const auto& element : filename_teeth_id_map)
	{
		std::string FILE_NAME("19486.vtp");
		int selected_id;

		boost::tie(FILE_NAME, selected_id) = boost::make_tuple(element.first, element.second);
