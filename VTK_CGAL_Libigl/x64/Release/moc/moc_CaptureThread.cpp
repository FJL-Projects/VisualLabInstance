...
#include <memory>
#include "../../../../src/main program/CaptureThread.h"
...
QT_MOC_LITERAL(1, 14, 14), // "requestCapture"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 11) // "frameNumber"

    },
    "CaptureThread\0requestCapture\0\0frameNumber"
};
...
void CaptureThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->requestCapture((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CaptureThread::requestCapture)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CaptureThread::requestCapture(int _t1)
{
